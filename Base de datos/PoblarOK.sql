...
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '6/13/2019', '2:27:00', '6/13/2019', '11:31:00', 2148781, 3);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '1/2/2019', '6:48:00', '5/29/2019', '1:59:00', 2148781, 2);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '7/7/2019', '1:57:00', '10/18/2019', '10:59:00', 2148781, 1);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '9/30/2018', '3:51:00', '7/8/2019', '5:35:00', 2148781, 2);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '11/4/2019', '3:33:00', '11/19/2018', '12:44:00', 2148781, 1);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '10/18/2019', '10:34:00', '8/22/2019', '6:31:00', 2148781, 1);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '1/9/2019', '10:41:00', '7/2/2019', '8:03:00', 2148781, 3);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '8/14/2018', '2:54:00', '10/3/2019', '10:59:00', 2148781, 1);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '3/11/2019', '3:57:00', '5/31/2019', '5:01:00', 2148781, 8);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '2/3/2019', '5:01:00', '4/23/2019', '6:40:00', 2148781, 1);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '3/24/2019', '9:10:00', '1/8/2019', '9:36:00', 2148781, 11);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '6/6/2019', '11:10:00', '11/3/2019', '11:25:00', 2148781, 1);
insert into reservados (idr, fechainicioreserva, horainicioreserva, fechafinreserva, horafinreserva, usuario, recurso) values (nextval('reservados_sequence'), '8/14/2018', '9:14:00', '7/12/2019', '8:48:00', 2148781, 10);

alter sequence reservados_sequence restart with 14;
